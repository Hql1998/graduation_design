...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setToolTip(_translate("self", "Tolerance for stopping criteria."))
        self.label_5.setText(_translate("self", "Tolerance"))
        self.label_7.setText(_translate("self", "10 ^"))
        self.label_6.setToolTip(_translate("self", "Maximum number of iterations of the optimization algorithm."))
        ...
        self.plot_lasso_cb.setText(_translate("self", "Plot lasso regularizaton profile"))
