...
class Save_Model_Btn(QPushButton):
    ...
    def open_file(self):
        ...
        open_re = QFileDialog.getSaveFileName(self, caption="save the model", directory=default_path_str, filter="sklearn joblib(*.joblib)", initialFilter='sklearn joblib(*.joblib)')
